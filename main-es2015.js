...
let FilmesComponent = class FilmesComponent {
    constructor(animateScrollService, titleService, DBService, router) {
    ...
    getDiscover(options) {
        ...
        this.isLoading = true;
        this.DBService.getDiscover('movie', options).subscribe((res) => {
...
let MovieDetailsComponent = class MovieDetailsComponent {
    constructor(route, dbService, dialog, domSanitizer, titleService, location, router) {
        this.route = route;
        this.dbService = dbService;
        this.dialog = dialog;
    ...
    ngOnInit() { }
    getMovieDetails(id) {
        this.dbService.getMovieDetails(id).subscribe((res) => {
            this.movie = res;
            this.getCast();
            this.titleService.setTitle(res.title);
            this.movie.poster_path = `${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].imgUrl}${this.movie.poster_path}`;
    ...
    getMovieVideos() {
        ...
        this.dbService.getMovieVideos(this.movieId).subscribe((res) => {
    ...
    getMovieReviews() {
        ...
        this.dbService.getMovieReviews(this.movieId).subscribe((res) => {
    ...
    similarMovies() {
        ...
        if (this.movieId) {
            this.dbService.getSimilarMovies(this.movieId).subscribe((res) => {
...
let TrailerDialogComponent = class TrailerDialogComponent {
...
let SearchComponent = class SearchComponent {
    constructor(DBService, router, titleService) {
        this.DBService = DBService;
        this.router = router;
        this.titleService = titleService;
    ...
    ngOnInit() {
        ...
        this.$search
            ...
            .subscribe(respostaComDelay => {
            if (!respostaComDelay.length) {
                this.getDiscover();
            }
            if (respostaComDelay.length > 2) {
                this.getMovies(respostaComDelay);
            }
        });
    }
    ngOnDestroy() {
...
let MovieDBService = class MovieDBService {
    ...
    getMovies(type) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getMovieDetails(movieId) {
        const movieDetilasUrl = `${this.API_BASE}movie/${movieId}`;
        return this.http.get(movieDetilasUrl, this.formatParams({})).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getMovieVideos(movieId) {
        const movieTrailersUrl = `${this.API_BASE}movie/${movieId}/videos`;
        return this.http.get(movieTrailersUrl, this.formatParams({})).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getMovieReviews(movieId) {
        const movieReviewUrl = `${this.API_BASE}movie/${movieId}/reviews`;
        return this.http.get(movieReviewUrl, this.formatParams({})).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getGenres() {
        const generesUrl = `${this.API_BASE}genre/movie/list`;
        return this.http.get(generesUrl, this.formatParams({})).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getkeywords(search) {
        const generesUrl = `${this.API_BASE}search/movie?api_key=${this.API_KEY}&query=${search}&page=1`;
        return this.http.get(generesUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    formatMovies(items) {
        const placeholderImg = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].placeholderImg;
        const imgUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].imgUrl;
    ...
    getSimilarMovies(movie_id) {
        ...
        return this.http.get(similarMovieUrl, this.formatParams({})).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getCastMovie(movie_id) {
        const castUrl = `${this.API_BASE}movie/${movie_id}/credits?api_key=${this.API_KEY}`;
        return this.http.get(castUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    getDiscover(type, options) {
        // options.api_key = this.API_KEY;
        const discoverUrl = `${this.API_BASE}discover/${type}`;
        return this.http.get(discoverUrl, this.formatParams(options)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => res), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    handleError(error) {
        let errMsg;
...
let SwService = class SwService {
    constructor(updates) {
        ...
        // check for updates
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(6 * 60 * 60).subscribe(() => updates.checkForUpdate());
...
let FilterComponent = class FilterComponent {
    constructor(DBService) {
        ...
        this.DBService.getGenres().subscribe((res) => (this.genresList = res.genres));
        this.options = {};
    }
    ngOnInit() {
